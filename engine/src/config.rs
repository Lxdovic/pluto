...
make_config! {
 ...
 hce_tempo_bonus_mg: i32 = ("HCETempoBonusMG", OptionKind::Spin, 28, 1, 50, true);
 hce_tempo_bonus_eg: i32 = ("HCETempoBonusEG", OptionKind::Spin, 0, 0, 50, true);
 hce_bishop_pair_bonus_mg: i32 = ("HCEBishopPairBonusMG", OptionKind::Spin, 10, 1, 50, true);
 hce_bishop_pair_bonus_eg: i32 = ("HCEBishopPairBonusEG", OptionKind::Spin, 8, 1, 50, true);
 hce_rook_open_file_bonus_mg: i32 = ("HCERookOpenFileBonusMG", OptionKind::Spin, 20, 1, 50, true);
 hce_rook_open_file_bonus_eg: i32 = ("HCERookOpenFileBonusEG", OptionKind::Spin, 0, 0, 50, true);
 hce_rook_semi_open_file_bonus_mg: i32 = ("HCERookSemiOpenFileBonusMG", OptionKind::Spin, 10, 1, 50, true);
 hce_rook_semi_open_file_bonus_eg: i32 = ("HCERookSemiOpenFileBonusEG", OptionKind::Spin, 0, 0, 50, true);
 hce_king_shield_factor_mg: i32 = ("HCEKingShieldFactorMG", OptionKind::Spin, 1, 1, 10, true);
 hce_king_shield_factor_eg: i32 = ("HCEKingShieldFactorEG", OptionKind::Spin, 1, 0, 10, true);
 hce_passed_pawn_bonus_mg: i32 = ("HCEPassedPawnBonusMG", OptionKind::Spin, 10, 1, 50, true);
 hce_passed_pawn_bonus_eg: i32 = ("HCEPassedPawnBonusEG", OptionKind::Spin, 10, 1, 50, true);
 hce_doubled_pawn_factor_mg: i32 = ("HCEDoubledPawnFactorMG", OptionKind::Spin, 5, 1, 10, true);
 hce_doubled_pawn_factor_eg: i32 = ("HCEDoubledPawnFactorEG", OptionKind::Spin, 5, 1, 10, true);
 hce_isolated_pawn_malus_mg: i32 = ("HCEIsolatedPawnMalusMG", OptionKind::Spin, 10, 1, 50, true);
 hce_isolated_pawn_malus_eg: i32 = ("HCEIsolatedPawnMalusEG", OptionKind::Spin, 10, 1, 50, true);
 hce_mobility_factor_mg: i32 = ("HCEMobilityFactorMG", OptionKind::Spin, 1, 1, 10, true);
 hce_mobility_factor_eg: i32 = ("HCEMobilityFactorEG", OptionKind::Spin, 1, 1, 10, true);
 // hce_: i32 = ("HCE", OptionKind::Spin, 28, 1, 50, true);
 // hce_: i32 = ("HCE", OptionKind::Spin, 28, 1, 50, true);
 // hce_: i32 = ("HCE", OptionKind::Spin, 28, 1, 50, true);
 // hce_: i32 = ("HCE", OptionKind::Spin, 28, 1, 50, true);
 // hce_: i32 = ("HCE", OptionKind::Spin, 28, 1, 50, true);
